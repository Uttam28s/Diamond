...
import {loadManagers, loadCarats} from "../../Action/Packet";
...
class CreateRough extends Component {
  ...
  componentDidMount = async() => { 
   await this.props.loadManagers().then(res => {
     console.log("this is a responce in a componentdidMount of a Packet :->",res)
    //  this.setState ( {
   ...
   await this.props.loadCarats().then(res=>{
    console.log("this is a Carat in a componentdidMount of a Packet :->",res)
   });
  }
...
export default connect(mapStateToProps , {loadManagers ,loadCarats})(CreateRoughs);
