import Test from "../Reducers/Home";
...
export default createStore( combineReducers({ Test, Packet }),{}, // Set Default state or initial state if needed else set blank as it is.
  compose(
